...
1. **`packages/security/audit-logging/README.md`** — overview, install, quick-start, module index
2. **`packages/security/audit-logging/src/**/*.md`** — co-located docs per implementation file (Purpose, Features, Basic + Advanced examples, full API reference, Implementation notes — all packages in genesis ship ≥200 words per module)
3. **`packages/security/audit-logging/package.json`** `exports` map — every subpath you can import from
