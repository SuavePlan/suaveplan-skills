...
1. **`packages/auth/slsa/README.md`** — overview, install, quick-start, module index
2. **`packages/auth/slsa/src/**/*.md`** — co-located docs per implementation file (Purpose, Features, Basic + Advanced examples, full API reference, Implementation notes — all packages in genesis ship ≥200 words per module)
3. **`packages/auth/slsa/package.json`** `exports` map — every subpath you can import from
